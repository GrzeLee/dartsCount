...
public class FirstGameModeSettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textGameInfo.setText(R.string.info_mode_1);
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.gameModes, R.layout.spinner_item);
            ...
            startGameButton.setOnClickListener(view -> {
                ...
                if(selectedItemNumber==0){
                    Intent intent = new Intent(FirstGameModeSettingActivity.this, OneDartModeActivity.class);
                    intent.putExtra("TIME_SENDER", convertTimeToMilliseconds());
                    startActivity(intent);
                }
                if(selectedItemNumber==1){
                    Intent intent = new Intent(FirstGameModeSettingActivity.this, TwoDartModeActivity.class);
                    intent.putExtra("TIME_SENDER", convertTimeToMilliseconds());
                    startActivity(intent);
                }
                if(selectedItemNumber==2){
                    Intent intent = new Intent(FirstGameModeSettingActivity.this, ThreeDartModeActivity.class);
                    intent.putExtra("TIME_SENDER", convertTimeToMilliseconds());
                    startActivity(intent);
                }
                finish();
    ...
    public void onBackPressed() {
        finish();
        Intent intent = new Intent(FirstGameModeSettingActivity.this,MainActivity.class);
        startActivity(intent);
    }
