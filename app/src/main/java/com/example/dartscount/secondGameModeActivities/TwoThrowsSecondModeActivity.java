...
public class TwoThrowsSecondModeActivity extends AppCompatActivity {

    public Button nextButton;
    public TextView numberToCount1,numberToCount2 ,infoView, score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countDownTimer = new CountDownTimer(receivedTimeValue, 1000) {
            ...
            public void onFinish() {
                ...
                //POPUP BUILDER
                PopupBuilder popupBuilder = new PopupBuilder(TwoThrowsSecondModeActivity.this);
    ...
    public void onBackPressed() {
        ...
        if (backTapCount==2){
            ...
            Intent intent =  new Intent(TwoThrowsSecondModeActivity.this, MainActivity.class);
    ...
    public String correctAnswer(){
        int throwsSum = Integer.parseInt(expectedResultAndDisplayedNumber1.getExpectedResult()) + Integer.parseInt(expectedResultAndDisplayedNumber2.getExpectedResult());
